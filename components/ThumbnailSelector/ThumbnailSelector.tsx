...
import { THUMBNAIL_CUSTOM, tournament_thumb_10_ball, tournament_thumb_8_ball, tournament_thumb_9_ball, tournament_thumb_bank_pool, tournament_thumb_one_pocket, tournament_thumb_straight_pool } from "../../hooks/constants";
    ...
    ]}>
      {
        thumbnailsReady.map((thumb:IThumbnailObj, key:number)=>{
          return <TouchableOpacity 
            ...
            (thumb.value===thumbnailType?StyleThumbnailSelector.thumb_active: null)
          ]}>
            <Image style={[
